...
$('.masonry-item__photo').on('click', function () {
   $(this).toggleClass('checked');
});

$('.masonry-item__full').on('click', function () {
    $(this).toggleClass('checked');
});
...
$('.card-item > a').on('click', function (e) {
   ...
   if ($(this).find('span[class*="glyph-"]').length && $(this).find('p[class="card-item__name"]').length) {
    ...
    if ($('.poll').find('.slick-current').data('slick-index') + 1 === $('.poll-item').length) {
        flag = true;
    }
...
$('.builder').on('click', function (e) {
    ...
    $('.manutan').toggleClass('start');
    $('.specifications').toggleClass('start');

    if($('.imagination').hasClass('start')) {
        $('.imagination').removeClass('start');
    }

    if (!$('.specifications').hasClass('start') && clicked) {
        $('.specifications').removeClass('start');
    }
